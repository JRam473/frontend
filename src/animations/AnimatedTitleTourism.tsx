// src/components/figma/AnimatedTitleTourism.tsx
...
const AnimatedPhrase: FC<{ 
  ...
  return (
    ...
    >
      ...
      <br />
      <span 
        className="block text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl bg-gradient-to-r from-green-300 via-emerald-400 to-lime-300 bg-clip-text text-transparent"
 ...
 */
export const AnimatedTitleTourism: FC = () => {
...
export const StaticTitle: FC<{ isMobile?: boolean }> = () => (
  <div className="flex flex-col items-center justify-center text-center overflow-hidden px-4">
    <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-extrabold font-serif leading-tight text-white drop-shadow-[0_4px_6px_rgba(0,0,0,0.8)]">
      Explora
      <br />
...
export default AnimatedTitleTourism;