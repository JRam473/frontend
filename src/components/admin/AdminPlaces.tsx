...
const PlaceCard = ({ 
  ...
  return (
    ...
    >
      <Card className="overflow-hidden shadow-card hover:shadow-xl transition-all duration-300 border-0 bg-white/90 backdrop-blur-sm border-white/30 flex flex-col w-full">
        <div className="relative h-48 overflow-hidden flex-shrink-0">
          ...
          <div className="absolute top-3 left-3">
            <Badge className={cn(getCategoryColor(place.category), "text-white border-0 shadow-md backdrop-blur-sm")}>
...
export const AdminPlaces = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      {/* 🎨 MISMO FONDO QUE LOS DEMÁS COMPONENTES */}
      <div 
      ...
      {/* 🎨 CONTENIDO */}
      <div className="relative z-10 space-y-6 h-full flex flex-col p-6">
        {/* Header */}
        <motion.div 
          initial={{ opacity: 0, y: -20 }}
          animate={{ opacity: 1, y: 0 }}
          className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 p-6 bg-white/10 backdrop-blur-sm rounded-2xl border border-white/20"
        >
          <div className="space-y-2">
            <h1 className="text-4xl font-bold text-white">
              Administrar <span className="text-blue-300">Lugares</span>
            </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            title='Actualizar lista de lugares'
              ...
              disabled={loading}
              className="bg-white/10 text-white border-white/20 hover:bg-white/20 flex gap-2"
            >
            ...
            <Dialog open={isDialogOpen} onOpenChange={handleDialogOpenChange}>
              <DialogTrigger asChild>
                <Button className="gap-2 bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white shadow-lg border-0">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
              ...
              title='Buscar Lugares'>
                ...
                <Input
                  ...
                  className="pl-9 border-white/20 bg-white/10 text-white placeholder-gray-300 focus:border-blue-300 focus:ring-blue-300"
                />
              </div>
              <CategoryFilter 
              ...
              <div className="flex gap-2">
                <Button
                  ...
                  className="flex-1 gap-2 bg-white/10 text-white border-white/20 hover:bg-white/20"
                >
        ...
        <div className="flex-1 min-h-0 overflow-hidden">
          <AnimatePresence mode="wait">
            {viewMode === 'grid' ? (
              ...
              >
                <Card className="border border-white/20 shadow-lg h-full flex flex-col bg-white/10 backdrop-blur-sm">
                  <CardHeader className="flex-shrink-0 bg-white/10 rounded-t-lg">
                  ...
                  <CardContent className="flex-1 min-h-0 p-0">
                    <div className="h-full overflow-auto">
                      <Table>
                        <TableHeader className="bg-white/10 sticky top-0">
                          <TableRow>
                            <TableHead className="text-white font-semibold">Lugar</TableHead>
                            ...
                            <TableHead className="text-white font-semibold">Calificación</TableHead>
                            <TableHead className="text-white font-semibold text-right">Acciones</TableHead>
                          </TableRow>
                        </TableHeader>
                        <TableBody>
                          {filteredPlaces.map((place) => (
                            <TableRow key={place.id} className="hover:bg-white/5">
                              ...
                              <TableCell>
                                <Badge 
                                  variant="secondary" 
                                  className={cn(getCategoryColor(place.category), "text-white backdrop-blur-sm")}
                                >
                                ...
                                <div className="flex justify-end gap-2">
                                  ...
                                  >
                                    <Button 
                                      ...
                                      className="text-blue-300 hover:text-blue-200 hover:bg-blue-500/30"
                                    >
                                      <Edit className="h-4 w-4" />
                                    </Button>
                                  </AdminErrorBoundary>
                                  ...
                                  >
                                    ...
                                    title='Gestionar Galería'
                                      ...
                                      className="text-green-300 hover:text-green-200 hover:bg-green-500/30"
                                    >
                                      <Grid3X3 className="h-4 w-4" />
                                    </Button>
                                  </AdminErrorBoundary>
                                  ...
                                  >
                                    ...
                                    title='Eliminar Lugar'
                                      ...
                                      className="text-red-300 hover:text-red-200 hover:bg-red-500/30"
                                    >
                                      <Trash2 className="h-4 w-4" />
                                    </Button>
                                  </AdminErrorBoundary>
        ...
        <AlertDialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
          <AlertDialogContent className="border border-white/20 shadow-2xl bg-white/10 backdrop-blur-sm">
